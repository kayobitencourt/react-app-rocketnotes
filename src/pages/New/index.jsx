...
export function New(){
  ...
  async function handleNewNote(){
    ...
    if(newTag){
      return alert("Voce deixou uma tag no campo para adicionar mas nao clicou em adicionar!!!");
    }

    if(newLink){
      return alert("Voce deixou um link no campo para adicionar mas nao clicou em adicionar!!!");
    }
